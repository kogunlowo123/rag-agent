...
app = FastAPI(
    title="RAG Agent",
    description="Retrieval-Augmented Generation agent that orchestrates document ingestion, chunking strategies, embedding generation, vector search, and context-aware answer synthesis with citation tracking and hallucination mitigation.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
