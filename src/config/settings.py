"""Application configuration for RAG Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="rag-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/rag_agent",
    ...
    opensearch_index: str = Field(default="rag_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="rag-agent-mcp", description="MCP server name")
